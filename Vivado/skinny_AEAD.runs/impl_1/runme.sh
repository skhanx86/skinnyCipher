...
HD_PWD='C:/Users/saini/OneDrive/Desktop/skinny_AEAD/skinny_AEAD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log skinny_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source skinny_top.tcl -notrace
