...
HD_PWD='C:/Users/saini/OneDrive/Desktop/skinny_AEAD/skinny_AEAD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log skinny_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source skinny_top.tcl
